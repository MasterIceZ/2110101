...
meteor_imgs = [pg.image.load(path.join(img_dir, x)).convert() for x in ["meteor_tiny.png", "meteor_small.png", "meteor_med.png", "meteor_big.png"]]
...
class Meteor(pg.sprite.Sprite):
    def __init__(self):
        pg.sprite.Sprite.__init__(self)
        self.cnt = random.randint(1, len(meteor_imgs))
        self.image = meteor_imgs[self.cnt - 1]
        self.image.set_colorkey(black)
        self.rect = self.image.get_rect()
